...
def apply_thresholds():
    if original_image is not None:
        ...
        display_processed_image_in_window(processed_image)
...
# Hàm hiển thị ảnh đã xử lý trong cửa sổ độc lập
def display_processed_image_in_window(image):
    ...
    processed_label_window = ttk.Label(processed_window, image=img)
    processed_label_window.image = img
    processed_label_window.pack()
